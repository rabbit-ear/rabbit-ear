...
test("intersect lines", () => {
  ...
  ear.math.equivalentVectors(clipLine[0], shouldBeLine[0]);
  ear.math.equivalentVectors(clipLine[1], shouldBeLine[1]);
  // no intersect
