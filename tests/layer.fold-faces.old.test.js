...
// test("fold_faces_with_assignments, 4-vertex all permutations of boundaries", () => {
// 	const res1 = [], res2 = [], res3 = [], res4 = [];
// 	// no boundary
// 	res4.push(ear.layer.fold_faces_with_assignments(
// 		[2, 2, 2, 2],
// 		Array.from("MMMM")));
...
// 	res1.push(ear.layer.fold_faces_with_assignments(
// 		[2, 2, 2, 2],
// 		Array.from("BBMM")));
// 	// face 0 and 1 surrounded
// 	res2.push(ear.layer.fold_faces_with_assignments(
// 		[2, 2, 2, 2],
// 		Array.from("BMBM")));
// 	// face 0, 1, 2 connected
// 	res3.push(ear.layer.fold_faces_with_assignments(
// 		[2, 2, 2, 2],
// 		Array.from("BMMB")));
...
test("fold_faces_with_assignments, 8-vertex", () => {
	const res1 = ear.layer.fold_faces_with_assignments(
		[2, 2, 2, 2, 2, 2, 2, 2],
		Array.from("MVBMFBFM"));
	expect(res1.filter(a => a !== undefined).length).toBe(2);

	const res2 = ear.layer.fold_faces_with_assignments(
		[2, 2, 2, 2, 2, 2, 2, 2],
		Array.from("MVMVBBBB"));
