...
test("topological sort", () => {
	const ordering = ear.layer.topologicalSort([[5, 2], [2, 1], [5, 1], [1, 0], [1, 3]]);
...
test("topological sort with cycle", () => {
	...
	const ordering = ear.layer.topologicalSort([[5, 2], [2, 1], [1, 5]]);
...
test("topological sort crane", () => {
	...
	const ordering = ear.layer.topologicalOrderNew(graph);
	const expected = [
