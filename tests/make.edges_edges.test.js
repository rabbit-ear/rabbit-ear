...
test("edges_edges square", () => {
  ...
  graph.vertices_edges = ear.graph.make_vertices_edges_unsorted(graph);
  const result = ear.graph.make_edges_edges(graph);
...
//   const result = ear.graph.make_edges_edges({
...
//   const res1 = ear.graph.make_edges_edges({
...
//   const res2 = ear.graph.make_edges_edges({ edges_vertices: [["hi"], ["hi"]] });
//   expect(res2[0]).toEqual(expect.arrayContaining([1]));
//   expect(res2[1]).toEqual(expect.arrayContaining([0]));
//   const res3 = ear.graph.make_edges_edges({ edges_vertices: [["hi"], ["bye"]] });
...
test("make edges_edges 7", () => {
  const result = ear.graph.make_edges_edges({ edges_vertices:[] });
