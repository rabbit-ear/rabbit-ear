declare const _default: {
    ...
    intersectCircleLine: (circle: Circle, line: VecLine2, _?: Function, lineDomain?: Function, epsilon?: number) => number[][];
    ...
    nearestPointOnLine: ({ vector, origin }: VecLine, point: number[], clampFunc?: Function, epsilon?: number) => number[];
    nearestPointOnPolygon: (polygon: [number, number][], point: [number, number]) => any;
    nearestPointOnCircle: ({ radius, origin }: Circle, point: number[]) => number[];
    ...
    lerpLines: (a: VecLine, b: VecLine, t: number) => VecLine;
    ...
    multiplyMatrix4Vector3: (m: number[], vector: number[]) => number[];
    multiplyMatrix4Line3: (m: number[], vector: number[], origin: number[]) => VecLine;
    ...
    makeMatrix4RotateX: (angle: number, origin?: number[]) => number[];
    makeMatrix4RotateY: (angle: number, origin?: number[]) => number[];
    makeMatrix4RotateZ: (angle: number, origin?: number[]) => number[];
    makeMatrix4Rotate: (angle: number, vector?: number[], origin?: number[]) => number[];
    makeMatrix4Scale: (scale?: number[], origin?: number[]) => number[];
    makeMatrix4UniformScale: (scale?: number, origin?: number[]) => number[];
    makeMatrix4ReflectZ: (vector: number[], origin?: number[]) => number[];
    ...
    multiplyMatrix3Vector3: (m: number[], vector: number[]) => number[];
    multiplyMatrix3Line3: (m: number[], vector: number[], origin: number[]) => VecLine;
    ...
    makeMatrix3RotateX: (angle: number, origin?: number[]) => number[];
    makeMatrix3RotateY: (angle: number, origin?: number[]) => number[];
    makeMatrix3RotateZ: (angle: number, origin?: number[]) => number[];
    makeMatrix3Rotate: (angle: number, vector?: number[], origin?: number[]) => number[];
    makeMatrix3Scale: (scale?: number[], origin?: number[]) => number[];
    makeMatrix3UniformScale: (scale?: number, origin?: number[]) => number[];
    makeMatrix3ReflectZ: (vector: number[], origin?: number[]) => number[];
    identity2x2: number[];
    identity2x3: number[];
    multiplyMatrix2Vector2: (matrix: number[], vector: number[]) => number[];
    multiplyMatrix2Line2: (matrix: number[], vector: number[], origin: number[]) => VecLine;
    ...
    makeMatrix2Scale: (scale?: number[], origin?: number[]) => number[];
    makeMatrix2UniformScale: (scale?: number, origin?: number[]) => number[];
    makeMatrix2Rotate: (angle: number, origin?: number[]) => number[];
    makeMatrix2Reflect: (vector: number[], origin?: number[]) => number[];
    ...
    uniqueLineToVecLine: ({ normal, distance }: UniqueLine) => VecLine;
    EPSILON: 0.000001;
    R2D: number;
    D2R: number;
    TWO_PI: number;
