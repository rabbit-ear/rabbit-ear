...
export function multiplyMatrix4Vector3(m: number[], vector: number[]): number[];
export function multiplyMatrix4Line3(m: number[], vector: number[], origin: number[]): VecLine;
...
export function makeMatrix4RotateX(angle: number, origin?: number[]): number[];
export function makeMatrix4RotateY(angle: number, origin?: number[]): number[];
export function makeMatrix4RotateZ(angle: number, origin?: number[]): number[];
export function makeMatrix4Rotate(angle: number, vector?: number[], origin?: number[]): number[];
export function makeMatrix4Scale(scale?: number[], origin?: number[]): number[];
export function makeMatrix4UniformScale(scale?: number, origin?: number[]): number[];
export function makeMatrix4ReflectZ(vector: number[], origin?: number[]): number[];
