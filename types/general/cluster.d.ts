export function clusterSortedGeneric(elements: any[], comparison: Function): number[][];
export function clusterUnsortedIndices(indices: any[], comparison: Function): number[][];
