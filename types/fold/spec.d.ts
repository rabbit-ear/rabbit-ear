...
export function filterKeysWithSuffix(obj: object, suffix: string): string[];
export function getAllPrefixes(obj: object): string[];
export function getAllSuffixes(obj: object): string[];
