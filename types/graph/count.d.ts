 ...
 */
declare function count(graph: FOLD, key: string): number;
declare namespace count {
     ...
     */
    function vertices({ vertices_coords, vertices_faces, vertices_vertices }: FOLD): number;
    /**
     * @description Get the number of edges in a graph.
     * @param {FOLD} graph a FOLD object
     * @returns {number} the number of edges in the graph
     */
    function edges({ edges_vertices, edges_faces }: FOLD): number;
    /**
     * @description Get the number of faces in a graph.
     * @param {FOLD} graph a FOLD object
     * @returns {number} the number of faces in the graph
     */
    function faces({ faces_vertices, faces_edges, faces_faces }: FOLD): number;
}
