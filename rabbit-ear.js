/* Rabbit Ear 0.9.0 alpha 2021-01-08 (c) Robby Kraft, MIT License */
(function (global, factory) {
  ...
  const add$2 = (a, b) => [a[0] + b[0], a[1] + b[1]];
  ...
  const curveArguments = function (...args) {
    ...
    const midpoint = add$2(tailPt, scale$1(vector, 0.5));
    const perpendicular = [vector[1], -vector[0]];
    const bezPoint = add$2(midpoint, scale$1(perpendicular, o_curve));
    const tailControl = add$2(tailPt, scale$1(sub(bezPoint, tailPt), o_pinch));
    const headControl = add$2(headPt, scale$1(sub(bezPoint, headPt), o_pinch));
  ...
  const OrigamiProto = {};
  OrigamiProto.prototype = Object.create(GraphProto$1);
