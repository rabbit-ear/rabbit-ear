...
(function (global, factory) {
  ...
  var VectorPrototype = function VectorPrototype(subtype) {
    ...
    var flip = function flip() {
      return Type.apply(void 0, _toConsumableArray$1(that.map(function (n) {
        return -n;
      })));
    };
    ...
    Object.defineProperty(proto, "copy", {
      value: function value() {
        return Type.apply(void 0, _toConsumableArray$1(that));
      }
    });
  ...
  var make_edges_collinearVertices = function make_edges_collinearVertices(_ref) {
    ...
    return edges.map(function (e) {
      return vertices_coords.filter(function (v) {
        return point_on_edge_exclusive(v, e[0], e[1], epsilon);
      });
    });
  };
  ...
  var make_vertex_pair_to_edge_map$1 = function make_vertex_pair_to_edge_map(_ref9) {
  ...
  var rebuild = function rebuild(graph) {
    ...
    var rebuilt = fragment(graph, epsilon);
  ...
  var populate = function populate(graph) {
    ...
    if (graph.faces_faces == null) {
      var faces_faces = make_faces_faces(graph);
  ...
  var vertex_degree = function vertex_degree(v, i, graph) {
  ...
  var face_simple = function face_simple(f, i, graph) {
  ...
  var setup_vertex = function setup_vertex(v, i, graph) {
    vertex_degree(v, i, graph);
  };

  var setup_face = function setup_face(f, i, graph) {
  ...
  var win = function () {
    ...
    if (isNode) {
      var _require = require("xmldom"),
          ...
          _XMLSerializer = _require.XMLSerializer;

      w.DOMParser = _DOMParser;
      w.XMLSerializer = _XMLSerializer;
      w.document = new _DOMParser().parseFromString(htmlString, "text/html");
    } else if (isBrowser) {
      w = window;
    }
  ...
  var is_iterable$1$1 = function is_iterable$1(obj) {
    return obj != null && typeof obj[Symbol.iterator] === "function";
  };

  var flatten_input$1$1 = function flatten_input$1() {
    for (var _len8 = arguments.length, args = new Array(_len8), _key8 = 0; _key8 < _len8; _key8++) {
      args[_key8] = arguments[_key8];
    }
    ...
    switch (args.length) {
      ...
      case 1:
        return is_iterable$1$1(args[0]) && typeof args[0] !== "string" ? flatten_input$1.apply(void 0, _toConsumableArray(args[0])) : [args[0]];

      default:
        return Array.from(args).map(function (a) {
          return is_iterable$1$1(a) ? _toConsumableArray(flatten_input$1(a)) : a;
        }).reduce(function (a, b) {
          return a.concat(b);
        }, []);
    }
  ...
  var append = function append(element, command) {
    ...
    var params = flatten_input$1$1(args).join(",");
  ...
  var line = function line() {
    ...
    for (var _len30 = arguments.length, endpoints = new Array(_len30), _key30 = 0; _key30 < _len30; _key30++) {
      endpoints[_key30] = arguments[_key30];
    }
  ...
  var polygon = function polygon() {
    ...
    for (var _len33 = arguments.length, pointsArray = new Array(_len33), _key33 = 0; _key33 < _len33; _key33++) {
      pointsArray[_key33] = arguments[_key33];
    }
  ...
  var polyline = function polyline() {
    ...
    for (var _len35 = arguments.length, pointsArray = new Array(_len35), _key35 = 0; _key35 < _len35; _key35++) {
      pointsArray[_key35] = arguments[_key35];
    }
  ...
  var arrow = function arrow() {
    ...
    shape.setPoints = function () {
      for (var _len43 = arguments.length, a = new Array(_len43), _key43 = 0; _key43 < _len43; _key43++) {
  ...
  var findElementInParams = function findElementInParams() {
    for (var _len45 = arguments.length, params = new Array(_len45), _key45 = 0; _key45 < _len45; _key45++) {
      params[_key45] = arguments[_key45];
    }
  ...
  var SVG = function SVG() {
    for (var _len47 = arguments.length, params = new Array(_len47), _key47 = 0; _key47 < _len47; _key47++) {
      params[_key47] = arguments[_key47];
    }
  ...
  var remove_non_boundary_edges = function remove_non_boundary_edges(graph) {
    ...
    var edge_map = remove_geometry_key_indices(graph, "edges", remove_indices);
      ...
      case 2:
        {
          ...
          var flat = (_math$core = math.core).semi_flatten_input.apply(_math$core, args);
      ...
      case 3:
        {
          ...
          var _flat = (_math$core2 = math.core).semi_flatten_input.apply(_math$core2, args);
          ...
          if (_flat.length === 4) {
            if (_flat[0].length >= 2 && _flat[1].length >= 2 && _flat[2].length >= 2 && _flat[3].length >= 2) {
              return [_flat[0][0], _flat[0][1], _flat[1][0], _flat[1][1], _flat[2][0], _flat[2][1], _flat[3][0], _flat[3][1]];
            }
          }

          if (_flat.length === 2) {
            if (_flat[0].length >= 4 && _flat[1].length >= 4) {
              return [_flat[0][0], _flat[0][1], _flat[0][2], _flat[0][3], _flat[1][0], _flat[1][1], _flat[1][2], _flat[1][3]];
            }

            return [].concat(_toConsumableArray(math.core.flatten_input(_flat[0])), _toConsumableArray(math.core.flatten_input(_flat[1])));
          }
        }
        break;
  ...
  var axiom1 = function axiom1(x1, y1, x2, y2) {
    var point = [x1, y1];
    var vector = math.core.normalize([x2 - x1, y2 - y1]);
    var solution = [point, vector];
    var parameters = {
      points: [[x1, y1], [x2, y2]]
    };
    return make_axiom_frame(1, [solution], parameters);
  };
  var axiom2 = function axiom2(x1, y1, x2, y2) {
    var mid = [(x1 + x2) / 2, (y1 + y2) / 2];
    var vec = math.core.normalize([x2 - x1, y2 - y1]);
  ...
  var axiom3 = function axiom3(pt1x, pt1y, vec1x, vec1y, pt2x, pt2y, vec2x, vec2y) {
    var parameters = {
      lines: [[[pt1x, pt1y], [vec1x, vec1y]], [[pt2x, pt2y], [vec2x, vec2y]]]
    };
    var solutions = math.core.bisect_lines2([pt1x, pt1y], [vec1x, vec1y], [pt2x, pt2y], [vec2x, vec2y]);
  ...
  var axiom = function axiom(number) {
    ...
    var params = Params.apply(void 0, [number].concat(args));
  ...
  var transform_scale = function transform_scale(fold, ratio, homothetic_center) {
    var matrix = math.core.make_matrix2_scale(ratio, homothetic_center);
    apply_matrix_to_fold(fold, matrix);
  };
  var transform_translate = function transform_translate(fold, dx, dy) {
    var matrix = math.core.make_matrix2_translation(dx, dy);
    apply_matrix_to_fold(fold, matrix);
  };
  var transform_matrix = function transform_matrix(fold, matrix) {
    apply_matrix_to_fold(fold, matrix);
  };
  ...
  var remove_collinear_vertices = function remove_collinear_vertices(graph, collinear) {
    ...
    remove_geometry_key_indices(graph, "vertices", collinear.map(function (c) {
      return c.vertex;
    }));
  };
  ...
  var make_faces_sidedness = function make_faces_sidedness(graph) {
    ...
    if (coloring == null) {
      coloring = "faces_re:matrix" in graph ? make_faces_coloring_from_faces_matrix$1(graph["faces_re:matrix"]) : faces_coloring(graph, 0);
    }
  ...
  var isWebWorker$2 = (typeof self === "undefined" ? "undefined" : _typeof(self)) === "object" && self.constructor && self.constructor.name === "DedicatedWorkerGlobalScope";
  ...
  if (isNode$3) {
    ...
    win$3.DOMParser = DOMParser$3;
    win$3.XMLSerializer = XMLSerializer$3;
    win$3.document = new DOMParser$3().parseFromString(htmlString$3, "text/html");
  }
  ...
  var make_vertex_pair_to_edge_map$2 = function make_vertex_pair_to_edge_map(_ref) {
    var edges_vertices = _ref.edges_vertices;
    var map = {};
    edges_vertices.map(function (ev) {
      return ev.sort(function (a, b) {
  ...
  var search_boundary = function search_boundary(graph) {
    ...
    var edgeMap = make_vertex_pair_to_edge_map$2(graph);
  ...
  if (isNode$4()) {
    ...
    win$4.DOMParser = DOMParser$4;
    win$4.XMLSerializer = XMLSerializer$4;
    win$4.document = new DOMParser$4().parseFromString(htmlString$4, "text/html");
  } else if (isBrowser$4()) {
  ...
  var svg_to_fold = function svg_to_fold(svg, options) {
    ...
    var graph = fragment$1(pre_frag, options.epsilon);
  ...
  var add_vertex_on_edge = function add_vertex_on_edge(graph, x, y, old_edge_index) {
    ...
    var edge_map = remove_geometry_key_indices(graph, "edges", [old_edge_index]);
    return {
      vertices: {
        "new": [{
  ...
  var split_convex_polygon$1 = function split_convex_polygon(graph, faceIndex, linePoint, lineVector) {
    ...
    var faces_map = remove_geometry_key_indices(graph, "faces", [faceIndex]);
    return {
      faces: {
        map: faces_map,
        replace: [{
  ...
  var prepare_to_fold = function prepare_to_fold(graph, point, vector, face_index) {
    ...
    graph["faces_re:coloring"] = make_faces_coloring_from_faces_matrix(graph["faces_re:matrix"]);
  ...
  var fold_through = function fold_through(graph, point, vector, face_index) {
    ...
    folded["faces_re:coloring"] = make_faces_coloring_from_faces_matrix(folded_faces_matrix);
  ...
  var apply_run_diff = function apply_run_diff(graph, diff) {
    ...
    if (diff.remove) {
      if (diff.remove.faces) {
        remove_geometry_key_indices(graph, "faces", diff.remove.faces);
      }

      if (diff.remove.edges) {
        remove_geometry_key_indices(graph, "edges", diff.remove.edges);
      }

      if (diff.remove.vertices) {
        remove_geometry_key_indices(graph, "vertices", diff.remove.vertices);
      }
    }
        ...
        case "edge":
          {
            ...
            [clone(e), clone(e)].forEach(function (o, j) {
  ...
  var drawDiagram = function drawDiagram(graph, group) {
    ...
    diagrams.map(function (d) {
      ...
      return arrow.map(function (a) {
        ...
        return group.arrow(p[0], p[1], prefs).curve(0.3).head({
          width: vmin * 0.035,
          height: vmin * 0.09
  ...
  var View = function View(graph) {
    for (var _len = arguments.length, args = new Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++) {
      args[_key - 1] = arguments[_key];
    }

    var svg = SVG.apply(void 0, args);
    var svgStyle = svg.stylesheet(DEFAULT_STYLE);
    var defs = svg.defs();
    ...
    var draw = function draw() {
      ...
      ["boundaries", "faces", "edges"].forEach(function (key) {
        return groups[key].strokeWidth(strokeWidth);
      });
    ...
    Object.defineProperty(svg, "draw", {
      value: draw
    });
    Object.defineProperty(svg, "fit", {
      value: fit
    });
    Object.defineProperty(svg, "setViewBox", {
      value: function value(x, y, w, h, padding) {
        return SVG.setViewBox(svg, x, y, w, h, padding);
      }
    });
    Object.defineProperty(svg, "options", {
      get: function get() {
        return options;
      }
    });
    Object.defineProperty(svg, "groups", {
      get: function get() {
        return groups;
      }
    });
  ...
  var Edges = function Edges(graph, edges) {
    var valley = function valley() {
      edges.forEach(function (i) {
        graph.edges_assignment[i] = "V";
      });
      return edges;
    };

    var mountain = function mountain() {
      edges.forEach(function (i) {
        graph.edges_assignment[i] = "M";
      });
      return edges;
    };
    ...
    Object.defineProperty(edges, "valley", {
      value: valley
    });
    Object.defineProperty(edges, "mountain", {
      value: mountain
    });
    Object.defineProperty(edges, "mark", {
      value: mark
    });
    return edges;
  };
  ...
  var boundary_methods = function boundary_methods(boundaries) {
    ...
    boundaries.clipSegment = function () {
      for (var _len5 = arguments.length, args = new Array(_len5), _key5 = 0; _key5 < _len5; _key5++) {
        args[_key5] = arguments[_key5];
      }
  ...
  var Prototype$3 = function Prototype() {
    var superProto = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    var proto = Object.assign(Object.create(Prototype$2()), empty(), superProto, {
      file_spec: file_spec,
      file_creator: file_creator
    });
    ...
    proto.square = function () {
      ...
      var rect = rectangle(1, 1);
      Object.keys(rect).forEach(function (key) {
        _this[key] = rect[key];
      });
    };

    proto.regularPolygon = function () {
      var _this2 = this;
      ...
      var rect = regular_polygon(sides, radius);
      Object.keys(rect).forEach(function (key) {
        _this2[key] = rect[key];
      });
    };
    ...
    proto.scale = function () {
      ...
      transform_scale.apply(void 0, [this].concat(args));
    };
    ...
    proto.segment = function () {
      var _math$core3;

      var s = (_math$core3 = math.core).flatten_input.apply(_math$core3, arguments).filter(function (n) {
        return typeof n === "number";
      });

      var boundary = getBoundaries.call(this);
      var c = boundary.clipSegment([s[0], s[1]], [s[2], s[3]]);
      ...
      var edges = collinear_edges(this, [c[0], c[1]], [c[2] - c[0], c[3] - c[1]]);
    ...
    proto.line = function () {
      ...
      var l = (_math$core4 = math.core).flatten_input.apply(_math$core4, arguments).filter(function (n) {
        return typeof n === "number";
      });

      var boundary = getBoundaries.call(this);
      var s = boundary.clipLine([l[0], l[1]], [l[2], l[3]]);
      var assignment = get_assignment.apply(void 0, arguments) || "F";
      add_edge(this, s[0], s[1], s[2], s[3], assignment).apply();
      rebuild(this);
      didModifyGraph.call(this);
      var edges = collinear_edges(this, [s[0], s[1]], [s[2] - s[0], s[3] - s[1]]);
      return Edges(this, edges);
    };

    proto.axiom = function () {
      var _math$core5;

      RabbitEar.axiom(2, start[0], start[1], end[0], end[1]).solutions.forEach(function (s) {
        return app.origami.line(s[0][0], s[0][1], s[1][0], s[1][1]);
      });
      fragment(this);
      this.clean2();

      var l = (_math$core5 = math.core).flatten_input.apply(_math$core5, arguments).filter(function (n) {
        return typeof n === "number";
      });
    ...
    proto.mark = function () {
      ...
      var s = (_math$core6 = math.core).get_vector_of_vectors.apply(_math$core6, arguments);
    ...
    proto.crease = function () {
      ...
      var folded = fold_through(this, line.origin, line.vector, face_index, assignment);
      Object.keys(folded).forEach(function (key) {
        _this4[key] = folded[key];
      });
    ...
    proto.creaseRay = function () {
      ...
      var faces = this.faces_vertices.map(function (fv) {
        return fv.map(function (v) {
          return _this5.vertices_coords[v];
        });
      });
      var intersecting = faces.map(function (face, i) {
        return math.core.intersection.convex_poly_ray_exclusive(face, ray.origin, ray.vector) === undefined ? undefined : i;
      }).filter(function (a) {
        return a !== undefined;
      }).sort(function (a, b) {
        return b - a;
      ...
      intersecting.forEach(function (index) {
        return split_convex_polygon$1(_this5, index, ray.origin, ray.vector, "F");
      });
    };
  ...
  var Origami = function Origami() {
    ...
    var origami = Object.assign(Object.create(Prototype$3()), args.filter(function (el) {
    ...
    var load = function load(data, options) {
      keys.forEach(function (key) {
        return delete origami[key];
      });
      var fold_file = convert$1(data).fold(options);
      Object.assign(origami, fold_file);

      if (origami.edges_vertices == null) {
        return;
      }
    ...
    var _get = function get(component) {
      ...
      if (component === "edges") {
        a.forEach(function (e) {
          e.vector = function () {
            var pA = origami.vertices_coords[e.vertices[0]];
            var pB = origami.vertices_coords[e.vertices[1]];
    ...
    var nearest = function nearest() {
      ...
      if (nears.edge != null) {
        nears.edge.vector = function () {
          var pA = origami.vertices_coords[nears.edge.vertices[0]];
          var pB = origami.vertices_coords[nears.edge.vertices[1]];
          return [pB[0] - pA[0], pB[1] - pA[1]];
        };
      }
    ...
    Object.defineProperty(origami, "collapse", {
      value: collapse
    });
    Object.defineProperty(origami, "flatten", {
      value: flatten
    });
    ...
    Object.defineProperty(origami, "vertices", {
      get: function get() {
        return _get.call(origami, "vertices");
      }
    });
    Object.defineProperty(origami, "edges", {
      get: function get() {
        return _get.call(origami, "edges");
      }
    });
    Object.defineProperty(origami, "faces", {
      get: function get() {
        return _get.call(origami, "faces");
      }
    });
  ...
  var Prototype$4 = function Prototype() {
    var proto = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    ...
    proto.segment = function () {
      ...
      var s = (_math$core5 = math.core).flatten_input.apply(_math$core5, arguments).filter(function (n) {
        return typeof n === "number";
      });

      var assignment = get_assignment$1.apply(void 0, arguments) || "F";
      add_edge(this, s[0], s[1], s[2], s[3], assignment).apply();
      rebuild(this);
    };
  ...
  var parseOptions$2 = function parseOptions() {
  ...
  var parseOptionsForView$1 = function parseOptionsForView() {
    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }
  ...
  var Origami$1 = function Origami() {
    for (var _len2 = arguments.length, args = new Array(_len2), _key2 = 0; _key2 < _len2; _key2++) {
      args[_key2] = arguments[_key2];
    }

    var origami = Object.assign(Object.create(Prototype$4()), args.filter(function (el) {
      return possibleFoldObject(el);
    }).shift() || square());
    clean(origami);
    ...
    var userDefaults = parseOptions$2.apply(void 0, args);
    Object.keys(userDefaults).forEach(function (key) {
      options[key] = userDefaults[key];
    });
    Object.defineProperty(origami, "nearest", {
    ...
    Object.defineProperty(origami, "clean", {
      value: function value() {
        return clean(origami);
      }
    });
    Object.defineProperty(origami, "snapshot", {
      get: function get() {
  ...
  var init$1 = function init() {
    ...
    var origami = Origami$1.apply(void 0, args);
    var view;

    switch (parseOptionsForView$1.apply(void 0, args)) {
      case "svg":
        view = View.apply(void 0, [origami].concat(args));
        Object.defineProperty(origami, "svg", {
          get: function get() {
  ...
  Object.assign(core$1, frames, object, collinear, isolated, keys$1, affine, validate, make, marks, select, query$1, kawasaki, Axioms);
