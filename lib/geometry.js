...
function is_degenerate(v){
	return Math.abs(v.reduce((a, b) => a + b, 0)) < EPSILON_HIGH$1;
}

function are_parallel2(a, b){
...
export { intersection, core, input as Input, Matrix, Vector, Line, Ray, Edge$1 as Edge, Circle };
