const MouseMoved = function () {
  ...
  app.origami.svg.mouseMoved = function (mouse) {
    ...
    document.querySelectorAll(".app-info-p")[0].innerHTML = "<b>cursor</b><br>x:"+(mouse.x).toFixed(2)+"<br>y:"+(mouse.y).toFixed(2)+"<br><br><b>nearest</b><br>point [" + nVertexI + "]<br>edge [" + nEdgeI + "]<br>face [" + nFaceI + "]<br>sector [" + nSectorI + "]";
