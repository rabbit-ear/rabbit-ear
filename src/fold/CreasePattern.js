...
import { possibleFoldObject } from "./validate";
import { keys as foldKeys } from "./keys";
import { rebuild as clean } from "./rebuild";
...
CreasePattern.empty = function () {
  return CreasePattern(Create.empty());
};
