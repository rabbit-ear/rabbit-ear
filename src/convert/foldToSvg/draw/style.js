...
const component_classes = {
	vertices: [],
	edges: ["unassigned", "flat", "valley", "mountain", "boundary"],
...
const style_component = (group, { attributes }, component) => {
	...
	Array.from(group.childNodes)
		...
		.forEach(child => Object.keys(attributes[component][child.getAttribute("class")] || {})
			.forEach(key => child.setAttributeNS(null, key, attributes[component][child.getAttribute("class")][key])));
};
