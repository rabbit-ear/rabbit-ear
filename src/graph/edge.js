...
const Edge = function (graph, node1, node2) {
   ...
   * @returns {Edge[]} array of adjacent edges
   * @example
   ...
   * @param {Edge} edge test adjacency between this and supplied parameter
   ...
   * @param {Edge} edge test similarity between this and parameter
   ...
   * @returns {Edge[]} array of duplicate Edge, empty array if none
   * @example
   ...
   * @param {Edge} otherEdge an adjacent edge
