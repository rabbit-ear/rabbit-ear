...
export default class SVGLoader{
	...
	convertToCreasePattern(data){
		// console.log(data.childNodes);
		// get CSS style header if it exists
		var cssStyle, styleTag = data.getElementsByTagName('style')[0];
