 ...
 * @param {number[][]} [overlap_matrix] the result of getFacesFacesOverlap,
 ...
 */
export const makeFacePairs = (graph, facesFacesOverlap) => {
...
// 	}
// 	if (!overlap_matrix) {
// 		overlap_matrix = getFacesFacesOverlap(graph);
// 	}
