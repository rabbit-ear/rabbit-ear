...
/**  Geometry Primitives  */
function line(x1, y1, x2, y2, className, id) {
...
function circle(x, y, radius, className, id) {
...
function polygon(pointArray, className, id) {
...
export default {
	...
	group, SVG,
	addClass, removeClass, setID, convertToViewbox
}
