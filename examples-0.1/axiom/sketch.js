...
origami.onMouseMove = function(event){
	...
	switch(origami.axiom){
		...
		case 3: origami.args[origami.axiom].lines = [
				RabbitEar.Line.fromPoints(origami.getPosition(origami.touchPoints[0]), origami.getPosition(origami.touchPoints[1])),
				RabbitEar.Line.fromPoints(origami.getPosition(origami.touchPoints[2]), origami.getPosition(origami.touchPoints[3]))
			];
			break;
		case 4: 
